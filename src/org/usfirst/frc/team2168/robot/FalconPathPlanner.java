...
public class FalconPathPlanner
{
	...
	public void leftRight(double[][] smoothPath, double robotTrackWidth)
	{
		...
		for (int i=0; i<gradient.length; i++)
		{
			...
			if(i>0)
			{
				...
				{
					System.out.println(deg + " mod 360 is " + (-360+deg));
	...
	public static void main(String[] args)
	{
		...
		if(!GraphicsEnvironment.isHeadless())
		{
			...
			//93inch(7.75ft) square base, with back feet, 108 (9ft) inches from center line.
			//http://www.usfirst.org/sites/default/files/uploadedFiles/Robotics_Programs/FRC/Game_and_Season__Info/2013/2013_Team_Drawings.pdf
			//located Center laterally on 24ft x 57ft field
			double[][] pyramidBase = new double[][]{
					{9, 12-(7.75/2)},
					{9+7.75, 12-(7.75/2)},
					{9+7.75, 12+(7.75/2)},
					{9, 12+(7.75/2)},
